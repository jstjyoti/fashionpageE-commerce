...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"dataSource\", function() { return dataSource; });\n/* harmony import */ var _createchart_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./createchart.js */ \"./src/js/createchart.js\");\n/* harmony import */ var _filterLink_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./filterLink.js */ \"./src/js/filterLink.js\");\n/* harmony import */ var _snackbar__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./snackbar */ \"./src/js/snackbar.js\");\nfunction ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }\n\nfunction _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(source, true).forEach(function (key) { _defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(source).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\nfunction _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _nonIterableSpread(); }\n\nfunction _nonIterableSpread() { throw new TypeError(\"Invalid attempt to spread non-iterable instance\"); }\n\nfunction _iterableToArray(iter) { if (Symbol.iterator in Object(iter) || Object.prototype.toString.call(iter) === \"[object Arguments]\") return Array.from(iter); }\n\nfunction _arrayWithoutHoles(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = new Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } }\n\nfunction _newArrowCheck(innerThis, boundThis) { if (innerThis !== boundThis) { throw new TypeError(\"Cannot instantiate an arrow function\"); } }\n\n/*eslint-disable*/\n\n\n\nvar dataSource = {\n  LINE_SEPERATOR: '\\n',\n  COL_SEPERATOR: /,(?=(?:(?:[^\"]*\"){2})*[^\"]*$)/,\n  dataformat: 'json',\n  axis: [],\n  selectedY: [],\n  init: function init(datacsv) {\n    var _this = this;\n\n    this.dataTable = [];\n    this.headers = [];\n    this.axis = [];\n    datacsv = datacsv.trim();\n    var lines = datacsv.split(this.LINE_SEPERATOR);\n    this.headers = lines[0].split(this.COL_SEPERATOR);\n\n    for (var _i = 1; _i < lines.length; _i++) {\n      this.dataTable.push(lines[_i].split(this.COL_SEPERATOR));\n    }\n\n    var btn = document.getElementById('btn-spreadsheet-modal');\n    btn.className = 'btn btn-done'; // btn.innerHTML = '<span class=\"fa fa-bar-chart\"></span>';\n\n    btn.onclick = function () {\n      _newArrowCheck(this, _this);\n\n      this.canHaveJson();\n      window.modalClose('modal-spreadsheet');\n    }.bind(this); // btn.setAttribute('onClick', 'javascript:dataSource.canHaveJson();modalClose(\\'modal-spreadsheet\\');');\n\n\n    document.getElementById('chart-type').removeAttribute('style');\n    this.showPreview();\n  },\n  canHaveJson: function canHaveJson() {\n    var selectedX = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.selectedX;\n    var selectedY = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.selectedY;\n    this.axis = [selectedX].concat(_toConsumableArray(selectedY));\n    var btn = document.getElementById('btn-spreadsheet-modal');\n    btn.setAttribute('onClick', 'modalClose(\\'modal-spreadsheet\\')');\n\n    if (!this.type || this.type === '') {\n      _snackbar__WEBPACK_IMPORTED_MODULE_2__[\"snackbar\"].showSnackbar('Select a chart Type');\n    }\n\n    if (!_createchart_js__WEBPACK_IMPORTED_MODULE_0__[\"chart\"]) {\n      Object(_createchart_js__WEBPACK_IMPORTED_MODULE_0__[\"createChart\"])(this.type);\n    }\n\n    if (selectedY == null || selectedY.length === 0) {\n      _snackbar__WEBPACK_IMPORTED_MODULE_2__[\"snackbar\"].showSnackbar('select some columns in y axis');\n    } // } else if (selectedX !== undefined && selectedY.length > 0) {\n\n\n    if (this.type.indexOf('ms') != -1 && selectedY.length >= 1) {\n      this.csvJSONMultiSeries();\n    } else {\n      this.csvJSONSingleSeries();\n    } // }\n\n  },\n  csvJSONSingleSeries: function csvJSONSingleSeries() {\n    var result = [];\n\n    for (var _i2 = 0; _i2 < this.dataTable.length; _i2++) {\n      var obj = {};\n\n      for (var j = 0; j < this.axis.length; j++) {\n        if (j == 0) {\n          obj['label'] = this.dataTable[_i2][this.axis[j]];\n        } else {\n          obj['value'] = this.dataTable[_i2][this.axis[j]];\n        }\n      }\n\n      result.push(obj);\n    } // console.log(result);\n\n\n    this.json = JSON.parse(JSON.stringify(result)); // JSON\n    // console.log(this.json);\n\n    this.createDataSource();\n  },\n  csvJSONMultiSeries: function csvJSONMultiSeries() {\n    this.categories = [], this.json = [];\n    var category = [];\n    var data = [];\n    var obj, i;\n\n    for (i = 0; i < this.dataTable.length; i++) {\n      obj = {};\n      obj['label'] = this.dataTable[i][this.axis[0]];\n      category.push(obj);\n    }\n\n    this.categories.push({\n      'category': category\n    });\n\n    for (var j = 1; j < this.axis.length; j++) {\n      data = [];\n\n      for (i = 0; i < this.dataTable.length; i++) {\n        obj = {};\n        obj['value'] = this.dataTable[i][this.axis[j]];\n        data.push(obj);\n      }\n\n      this.json.push({\n        'seriesname': this.headers[this.axis[j]],\n        'data': data\n      });\n    }\n\n    this.createDataSource();\n  },\n  csvJSONXYcharts: function csvJSONXYcharts() {\n    // for xy charts\n    this.categories = [], this.json = [];\n    var category = [];\n    var data = [];\n    var obj;\n\n    for (i = 0; i < this.dataTable.length; i++) {\n      obj = {};\n      obj['label'] = this.dataTable[i][this.axis[0]];\n      category.push(obj);\n    }\n\n    this.categories.push({\n      'category': category\n    });\n\n    for (var j = 1; j < this.axis.length; j++) {\n      data = [];\n\n      for (i = 0; i < this.dataTable.length; i++) {\n        obj = {};\n        obj['value'] = this.dataTable[i][this.axis[j]];\n        data.push(obj);\n      }\n\n      this.json.push({\n        'seriesname': this.headers[this.axis[j]],\n        'data': data\n      });\n    }\n\n    this.createDataSource();\n  },\n  createDataSource: function createDataSource() {\n    var dataset = this.json;\n    var datasource;\n    var chartobj = {\n      'caption': 'click to add caption',\n      'subcaption': 'click to add subcaption',\n      'xaxisname': 'Enter X axis name',\n      'yaxisname': 'Enter Y axis name'\n    };\n\n    if (_createchart_js__WEBPACK_IMPORTED_MODULE_0__[\"chartObject\"]) {\n      chartobj = _objectSpread({}, chartobj, {}, _createchart_js__WEBPACK_IMPORTED_MODULE_0__[\"chartObject\"]['chart']);\n    }\n\n    if (this.type.indexOf('ms') == -1) {\n      datasource = {\n        'chart': chartobj,\n        'data': dataset\n      };\n    } else {\n      datasource = {\n        'chart': chartobj,\n        'categories': this.categories,\n        'dataset': dataset\n      };\n    }\n\n    _createchart_js__WEBPACK_IMPORTED_MODULE_0__[\"chart\"].chartType(this.type);\n    Object(_createchart_js__WEBPACK_IMPORTED_MODULE_0__[\"setChartObject\"])(datasource);\n    var jsonTextArea = document.getElementById('json-textarea');\n\n    if (jsonTextArea) {\n      jsonTextArea.value = JSON.stringify(_createchart_js__WEBPACK_IMPORTED_MODULE_0__[\"chartObject\"], null, 2);\n    }\n\n    if (localStorage) {\n      localStorage.setItem('slateDataSource', JSON.stringify(dataSource));\n    }\n\n    _createchart_js__WEBPACK_IMPORTED_MODULE_0__[\"chart\"].setJSONData(Object(_filterLink_js__WEBPACK_IMPORTED_MODULE_1__[\"filterLink\"])());\n  },\n  _fillTable: function _fillTable(tbl) {\n    var _this2 = this;\n\n    var tr;\n    var td;\n    var cellTag = 'th';\n    var dictIdx = [];\n    var pallets = 3;\n    var selectedX = this.axis[0];\n\n    var selectedY = _toConsumableArray(this.axis.slice(1));\n\n    tbl.innerHTML = '';\n    tr = document.createElement('tr');\n    td = document.createElement(cellTag);\n    td.innerHTML = 'SL';\n    tr.appendChild(td);\n    this.headers.forEach(function (col, colIdx) {\n      _newArrowCheck(this, _this2);\n\n      td = document.createElement(cellTag);\n      td.setAttribute('onclick', 'selectAxisMenu(event, ' + colIdx + ')');\n      td.setAttribute('oncontextmenu', 'selectAxisMenu(event, ' + colIdx + ')');\n\n      if (selectedX === colIdx) {\n        td.className = 'selected-x';\n      }\n\n      if (selectedY.includes(colIdx)) {\n        td.className = 'selected-y';\n      }\n\n      td.innerHTML = col;\n      tr.appendChild(td);\n    }.bind(this));\n    tbl.appendChild(tr);\n    cellTag = 'td';\n    this.dataTable.forEach(function (line, lineNo) {\n      var _this3 = this;\n\n      _newArrowCheck(this, _this2);\n\n      tr = document.createElement('tr');\n      td = document.createElement(cellTag);\n      td.className = 'row-idx';\n      td.innerHTML = lineNo + 1;\n      tr.appendChild(td);\n      line.forEach(function (col, colIdx) {\n        _newArrowCheck(this, _this3);\n\n        td = document.createElement(cellTag);\n        td.setAttribute('onclick', 'selectAxisMenu(event, ' + colIdx + ')');\n        td.setAttribute('oncontextmenu', 'selectAxisMenu(event, ' + colIdx + ')');\n        td.innerHTML = col;\n        tr.appendChild(td);\n      }.bind(this));\n      tbl.appendChild(tr);\n    }.bind(this));\n  },\n  showPreview: function showPreview() {\n    var tbl = document.getElementById('table-csv');\n\n    this._fillTable(tbl);\n\n    document.getElementById('table-container').addEventListener('click', function (e) {\n      e.stopPropagation();\n    });\n    document.getElementById('table-container').addEventListener('contextmenu', function (e) {\n      e.preventDefault();\n      e.stopPropagation();\n    });\n    document.getElementById('table-container').style.cssText = 'height:' + (window.innerHeight - document.getElementById('modal-nav').offsetHeight - document.getElementById('header').offsetHeight - 70) + 'px;';\n  },\n  cleanSelection: function cleanSelection() {\n    var _this4 = this;\n\n    var toSelect = document.getElementById('table-csv').querySelector('tr:first-child th.selected-x');\n\n    if (toSelect) {\n      toSelect.classList.remove('selected-x');\n    }\n\n    toSelect = document.getElementById('table-csv').querySelectorAll('tr:first-child th.selected-y');\n\n    if (toSelect) {\n      Array.from(toSelect).forEach(function (e) {\n        _newArrowCheck(this, _this4);\n\n        return e.classList.remove('selected-y');\n      }.bind(this));\n    }\n\n    dataSource.selectedY = [];\n    dataSource.selectedX = undefined;\n    dataSource.axis = [];\n  },\n  cleanData: function cleanData() {\n    dataSource.dataTable = [];\n    dataSource.headers = [];\n  }\n};\n\nwindow.hideSelectAxisMenu = function () {\n  var menu = document.getElementById('select-axis-menu');\n\n  if (menu) {\n    // menu.classList.add('hidden');\n    menu.style.display = 'none';\n    window.removeEventListener('onclick', hideSelectAxisMenu);\n  }\n};\n\nwindow.createSelectAxisMenu = function (options, callback) {\n  var _this5 = this;\n\n  var menu = document.createElement('div');\n  var btn;\n  menu.id = 'select-axis-menu';\n  menu.className = 'select-axis-menu';\n  options.forEach(function (option) {\n    _newArrowCheck(this, _this5);\n\n    btn = document.createElement('a');\n    btn.href = '#!';\n    btn.innerHTML = option;\n\n    btn.onclick = function () {\n      callback(option);\n    };\n\n    menu.appendChild(btn);\n  }.bind(this));\n  document.body.appendChild(menu);\n  return menu;\n};\n\nwindow.updateMenuOptions = function (menu, options, callback) {\n  var _this6 = this;\n\n  menu.innerHTML = '';\n  options.forEach(function (option) {\n    _newArrowCheck(this, _this6);\n\n    var btn = document.createElement('a');\n    btn.href = '#!';\n    btn.innerHTML = option;\n\n    btn.onclick = function () {\n      callback(option);\n    };\n\n    menu.appendChild(btn);\n  }.bind(this));\n};\n\nwindow.handleSelectAxis = function (val) {\n  var _this7 = this;\n\n  if (val.indexOf('X') >= 0) {\n    var toSelect = document.getElementById('table-csv').querySelector('tr:first-child th:nth-child(' + (dataSource.currentlySelected + 2) + ')');\n    toSelect.classList.toggle('selected-x');\n    var btn = document.getElementById('btn-spreadsheet-modal'); // btn.setAttribute('onClick', 'javascript:dataSource.canHaveJson();modalClose(\\'modal-spreadsheet\\');');\n\n    btn.onclick = function () {\n      _newArrowCheck(this, _this7);\n\n      dataSource.canHaveJson();\n      window.modalClose('modal-spreadsheet');\n    }.bind(this);\n\n    if (dataSource.selectedX === dataSource.currentlySelected) {\n      dataSource.selectedX = undefined;\n    } else {\n      if (dataSource.selectedX !== undefined) {\n        // previously selected\n        document.getElementById('table-csv').querySelector('tr:first-child th:nth-child(' + (dataSource.selectedX + 2) + ')').classList.remove('selected-x');\n      }\n\n      dataSource.selectedX = dataSource.currentlySelected;\n    }\n  } else if (val.indexOf('Y') >= 0) {\n    var _btn = document.getElementById('btn-spreadsheet-modal'); // btn.setAttribute('onClick', 'javascript:dataSource.canHaveJson();modalClose(\\'modal-spreadsheet\\');');\n\n\n    _btn.removeAttribute('onClick');\n\n    _btn.onclick = function () {\n      _newArrowCheck(this, _this7);\n\n      dataSource.canHaveJson();\n      window.modalClose('modal-spreadsheet');\n    }.bind(this);\n\n    var found = dataSource.selectedY.indexOf(dataSource.currentlySelected);\n\n    var _toSelect = document.getElementById('table-csv').querySelector('tr:first-child th:nth-child(' + (dataSource.currentlySelected + 2) + ')');\n\n    _toSelect.classList.toggle('selected-y');\n\n    if (dataSource.type.indexOf('ms') == -1) {\n      if (found >= 0) {\n        dataSource.selectedY = [];\n      } else {\n        dataSource.selectedY.forEach(function (colIdx) {\n          _newArrowCheck(this, _this7);\n\n          var toSelect = document.getElementById('table-csv').querySelector('tr:first-child th:nth-child(' + (colIdx + 2) + ')');\n          toSelect.classList.toggle('selected-y');\n        }.bind(this));\n        dataSource.selectedY = [dataSource.currentlySelected];\n      } // console.log(\"check\")\n\n    } else {\n      if (found >= 0) {\n        dataSource.selectedY.splice(found, 1);\n      } else {\n        dataSource.selectedY.push(dataSource.currentlySelected);\n      }\n    }\n  }\n};\n\nwindow.selectAxisMenu = function (e, colIdx) {\n  var _this8 = this;\n\n  var menu = document.getElementById('select-axis-menu');\n  var options = ['Select as X axis', 'Select as Y axis'];\n  dataSource.currentlySelected = colIdx;\n\n  if (dataSource.selectedX === colIdx) {\n    options[0] = 'Deselect as X axis';\n    options = options.slice(0, 1);\n  }\n\n  if (dataSource.selectedY.includes(colIdx)) {\n    options[0] = 'Deselect as Y axis';\n    options = options.slice(0, 1);\n  }\n\n  if (dataSource.type) {\n    if (!menu) {\n      menu = createSelectAxisMenu(options, function (val) {\n        _newArrowCheck(this, _this8);\n\n        handleSelectAxis(val);\n      }.bind(this));\n    } else {\n      updateMenuOptions(menu, options, function (val) {\n        _newArrowCheck(this, _this8);\n\n        handleSelectAxis(val);\n      }.bind(this));\n    }\n\n    menu.style.cssText = 'left:' + (e.clientX - 30) + 'px;top:' + (e.clientY + 10) + 'px';\n    window.addEventListener('click', hideSelectAxisMenu);\n  } else {\n    _snackbar__WEBPACK_IMPORTED_MODULE_2__[\"snackbar\"].showSnackbar('Select chart type first');\n  }\n};\n\n\n\n//# sourceURL=webpack:///./src/js/dataSource.js?");

/***/ }),

/***/ "./src/js/filterLink.js":
/*!******************************!*\
  !*** ./src/js/filterLink.js ***!
  \******************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"filterLink\", function() { return filterLink; });\n/* harmony import */ var _createchart__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./createchart */ \"./src/js/createchart.js\");\n/*eslint-disable*/\n\nfunction filterLink() {\n  var modifiedObject = JSON.stringify(_createchart__WEBPACK_IMPORTED_MODULE_0__[\"chartObject\"]);\n\n  try {\n    modifiedObject = JSON.parse(modifiedObject);\n\n    if (modifiedObject['chart']['clickURL']) {\n      delete modifiedObject['chart']['clickURL'];\n    }\n  } catch (e) {}\n\n  function checkType() {\n    var type = _createchart__WEBPACK_IMPORTED_MODULE_0__[\"chart\"].chartType();\n    var types = {\n      'singleseries': ['column2d', 'area2d', 'line', 'bar2d'],\n      'mutliseries': ['mscolumn2d']\n    };\n\n    for (var t in types) {\n      for (var series in types[t]) {\n        if (series === type) {\n          return series;\n        }\n      }\n    }\n  }\n\n  var dataSeries = checkType();\n\n  if (dataSeries === 'singleseries') {\n    var _iteratorNormalCompletion = true;\n    var _didIteratorError = false;\n    var _iteratorError = undefined;\n\n    try {\n      for (var _iterator = modifiedObject['data'][Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {\n        var value = _step.value;\n\n        if (value['link']) {\n          delete value['link'];\n        }\n      }\n    } catch (err) {\n      _didIteratorError = true;\n      _iteratorError = err;\n    } finally {\n      try {\n        if (!_iteratorNormalCompletion && _iterator[\"return\"] != null) {\n          _iterator[\"return\"]();\n        }\n      } finally {\n        if (_didIteratorError) {\n          throw _iteratorError;\n        }\n      }\n    }\n  } else if (dataSeries === 'multiseries') {\n    var _iteratorNormalCompletion2 = true;\n    var _didIteratorError2 = false;\n    var _iteratorError2 = undefined;\n\n    try {\n      for (var _iterator2 = modifiedObject['dataset'][Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {\n        var depth1 = _step2.value;\n        var _iteratorNormalCompletion3 = true;\n        var _didIteratorError3 = false;\n        var _iteratorError3 = undefined;\n\n        try {\n          for (var _iterator3 = depth1['data'][Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {\n            var depth2 = _step3.value;\n\n            if (depth2['link']) {\n              delete depth2['link'];\n            }\n          }\n        } catch (err) {\n          _didIteratorError3 = true;\n          _iteratorError3 = err;\n        } finally {\n          try {\n            if (!_iteratorNormalCompletion3 && _iterator3[\"return\"] != null) {\n              _iterator3[\"return\"]();\n            }\n          } finally {\n            if (_didIteratorError3) {\n              throw _iteratorError3;\n            }\n          }\n        }\n      }\n    } catch (err) {\n      _didIteratorError2 = true;\n      _iteratorError2 = err;\n    } finally {\n      try {\n        if (!_iteratorNormalCompletion2 && _iterator2[\"return\"] != null) {\n          _iterator2[\"return\"]();\n        }\n      } finally {\n        if (_didIteratorError2) {\n          throw _iteratorError2;\n        }\n      }\n    }\n  }\n\n  return modifiedObject;\n}\n\n//# sourceURL=webpack:///./src/js/filterLink.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _createchart_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./createchart.js */ \"./src/js/createchart.js\");\n/* harmony import */ var _snackbar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./snackbar */ \"./src/js/snackbar.js\");\n/* harmony import */ var _dataSource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dataSource */ \"./src/js/dataSource.js\");\n/* harmony import */ var _filterLink__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./filterLink */ \"./src/js/filterLink.js\");\n/* harmony import */ var _aside_accordian__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./aside/accordian */ \"./src/js/aside/accordian.js\");\n/* harmony import */ var _aside_edit_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./aside/edit_json */ \"./src/js/aside/edit_json.js\");\n/* harmony import */ var _aside_exportHTML__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./aside/exportHTML */ \"./src/js/aside/exportHTML.js\");\nfunction _newArrowCheck(innerThis, boundThis) { if (innerThis !== boundThis) { throw new TypeError(\"Cannot instantiate an arrow function\"); } }\n\n\n\n\n\n\n\n\n\nwindow.openJSONEditor = function () {\n  var _this = this;\n\n  var asideMenu = document.getElementById('aside-menu-wraper');\n  var workspace = document.getElementById('workspace');\n  var btnAside = document.getElementById('btn-open-aside');\n  var btnJSON = document.getElementById('btn-open-json');\n  var chartContainer = document.getElementById('chart-container');\n  var needResize = document.getElementById('chart-width').value.trim() === '' || document.getElementById('chart-height').value.trim() === '';\n\n  if (needResize) {\n    chartContainer.style.cssText = 'height:' + chartContainer.offsetHeight + 'px;width:' + chartContainer.offsetWidth + 'px;opacity:0;';\n    setTimeout(function () {\n      _newArrowCheck(this, _this);\n\n      chartContainer.style.cssText = 'opacity:0';\n    }.bind(this), 300);\n    setTimeout(function () {\n      _newArrowCheck(this, _this);\n\n      chartContainer.removeAttribute('style');\n    }.bind(this), 600);\n  }\n\n  if (_createchart_js__WEBPACK_IMPORTED_MODULE_0__[\"chart\"]) {\n    btnJSON.setAttribute('onclick', 'closeAsideMenu()');\n    btnJSON.innerHTML = '<span class=\"fa fa-remove\"></span>';\n    btnAside.setAttribute('onclick', 'openAsideMenu()');\n    btnAside.innerHTML = '<span class=\"fa fa-sliders\"></span>';\n    workspace.classList.remove('full');\n    workspace.classList.add('half');\n    asideMenu.classList.add('half');\n    asideMenu.style.display = 'inline-block';\n    var json = document.getElementById('json');\n    var accordian = document.getElementById('aside-customize');\n\n    if (json) {\n      json.removeAttribute('style');\n      document.getElementById('json-textarea').value = JSON.stringify(_createchart_js__WEBPACK_IMPORTED_MODULE_0__[\"chartObject\"], null, 2);\n    } else {\n      Object(_aside_edit_json__WEBPACK_IMPORTED_MODULE_5__[\"editJson\"])();\n    }\n\n    if (accordian) {\n      accordian.style.cssText = 'display:none;';\n    }\n  } else {\n    _snackbar__WEBPACK_IMPORTED_MODULE_1__[\"snackbar\"].showSnackbar('No chart rendered yet');\n  }\n};\n\nwindow.openAsideMenu = function () {\n  var _this2 = this;\n\n  var asideMenu = document.getElementById('aside-menu-wraper');\n  var workspace = document.getElementById('workspace');\n  var btnAside = document.getElementById('btn-open-aside');\n  var btnJSON = document.getElementById('btn-open-json');\n  var chartContainer = document.getElementById('chart-container');\n  var needResize = document.getElementById('chart-width').value.trim() === '' || document.getElementById('chart-height').value.trim() === '';\n\n  if (needResize) {\n    chartContainer.style.cssText = 'height:' + chartContainer.offsetHeight + 'px;width:' + chartContainer.offsetWidth + 'px;opacity:0;';\n    setTimeout(function () {\n      _newArrowCheck(this, _this2);\n\n      chartContainer.style.cssText = 'opacity:0';\n    }.bind(this), 300);\n    setTimeout(function () {\n      _newArrowCheck(this, _this2);\n\n      chartContainer.removeAttribute('style');\n    }.bind(this), 600);\n  }\n\n  if (_createchart_js__WEBPACK_IMPORTED_MODULE_0__[\"chart\"]) {\n    btnJSON.setAttribute('onclick', 'openJSONEditor()');\n    btnJSON.innerHTML = '<span class=\"fa fa-code\"></span>';\n    btnAside.setAttribute('onclick', 'closeAsideMenu()');\n    btnAside.innerHTML = '<span class=\"fa fa-remove\"></span>';\n    workspace.classList.remove('full');\n    workspace.classList.remove('half');\n    asideMenu.classList.remove('half');\n    var json = document.getElementById('json');\n    var accordian = document.getElementById('aside-customize');\n\n    if (json) {\n      json.style.display = 'none';\n    }\n\n    if (accordian) {\n      accordian.removeAttribute('style');\n    }\n\n    asideMenu.style.display = 'inline-block';\n  } else {\n    _snackbar__WEBPACK_IMPORTED_MODULE_1__[\"snackbar\"].showSnackbar('No chart rendered yet');\n  }\n};\n\nwindow.closeAsideMenu = function () {\n  var _this3 = this;\n\n  var asideMenu = document.getElementById('aside-menu-wraper');\n  var workspace = document.getElementById('workspace');\n  var btnAside = document.getElementById('btn-open-aside');\n  var btnJSON = document.getElementById('btn-open-json');\n  var chartContainer = document.getElementById('chart-container');\n  var needResize = document.getElementById('chart-width').value.trim() === '' || document.getElementById('chart-height').value.trim() === '';\n\n  if (needResize) {\n    chartContainer.style.cssText = 'height:' + chartContainer.offsetHeight + 'px;width:' + chartContainer.offsetWidth + 'px;opacity:0;';\n    setTimeout(function () {\n      _newArrowCheck(this, _this3);\n\n      chartContainer.style.cssText = 'opacity:0';\n    }.bind(this), 300);\n    setTimeout(function () {\n      _newArrowCheck(this, _this3);\n\n      chartContainer.removeAttribute('style');\n    }.bind(this), 600);\n  }\n\n  btnJSON.setAttribute('onclick', 'openJSONEditor()');\n  btnJSON.innerHTML = '<span class=\"fa fa-code\"></span>';\n  btnAside.setAttribute('onclick', 'openAsideMenu()');\n  btnAside.innerHTML = '<span class=\"fa fa-sliders\"></span>';\n  workspace.classList.remove('half');\n  workspace.classList.add('full');\n  asideMenu.style.display = 'none'; // close all accordion dropdowns as well\n\n  var dom = document.getElementsByClassName('dropdown');\n\n  for (var index = 0; index < dom.length; index++) {\n    dom[index].style.display = 'none';\n  } // clear parentEvent\n\n\n  _aside_accordian__WEBPACK_IMPORTED_MODULE_4__[\"functionWrapper\"].resetGlobal();\n};\n\nwindow.modalOpen = function (elemId) {\n  var modalContainer = document.getElementById('modal-container');\n  var modal = document.getElementById(elemId);\n  var workspace = document.getElementById('workspace-container');\n  modalContainer.style.display = 'block';\n  workspace.style.opacity = '0';\n  modalContainer.classList.add('opened');\n  setTimeout(function () {\n    modal.classList.add('opened');\n  }, 200);\n};\n\nwindow.modalClose = function (elemId) {\n  var modalContainer = document.getElementById('modal-container');\n  var modal = document.getElementById(elemId);\n  var workspace = document.getElementById('workspace-container');\n  modalContainer.classList.remove('opened');\n  workspace.style.opacity = '1';\n  setTimeout(function () {\n    modalContainer.style.display = 'none';\n  }, 300);\n  modal.classList.remove('opened');\n};\n\nwindow.initChartSelection = function () {\n  var select = document.getElementById('chart-type');\n  var chartTypes = ['line', 'area2d', 'pie2d', 'pie3d', 'column2d', 'column3d', 'bar2d', 'bar3d', 'mscolumn2d', 'mscolumn3d', 'msbar2d', 'msbar3d'];\n\n  for (var _i = 0, _chartTypes = chartTypes; _i < _chartTypes.length; _i++) {\n    var chartType = _chartTypes[_i];\n    var option = document.createElement('option');\n    option.value = chartType;\n    option.innerHTML = chartType;\n    select.appendChild(option);\n  }\n\n  select.onchange = function () {\n    var _this4 = this;\n\n    var btn = document.getElementById('btn-spreadsheet-modal');\n    btn.removeAttribute('onClick');\n\n    btn.onclick = function () {\n      _newArrowCheck(this, _this4);\n\n      _dataSource__WEBPACK_IMPORTED_MODULE_2__[\"dataSource\"].canHaveJson();\n      window.modalClose('modal-spreadsheet');\n    }.bind(this);\n\n    if (_dataSource__WEBPACK_IMPORTED_MODULE_2__[\"dataSource\"].type && _dataSource__WEBPACK_IMPORTED_MODULE_2__[\"dataSource\"].type.indexOf('ms') >= 0) {\n      if (select.value.indexOf('ms') === -1) {\n        _dataSource__WEBPACK_IMPORTED_MODULE_2__[\"dataSource\"].cleanSelection();\n      }\n    }\n\n    _dataSource__WEBPACK_IMPORTED_MODULE_2__[\"dataSource\"].type = select.value; // dataSource.canHaveJson(0, [1]);\n  };\n};\n\nwindow.clearSession = function () {\n  localStorage.removeItem('slateDataSource');\n  localStorage.removeItem('slateChartObject');\n};\n\nwindow.restoreSession = function () {\n  var _this5 = this;\n\n  var oldDataSource = localStorage.getItem('slateDataSource');\n  var oldChartObject = localStorage.getItem('slateChartObject');\n  var select = document.getElementById('chart-type');\n  var btn = document.getElementById('btn-spreadsheet-modal');\n  var skipList = ['LINE_SEPERATOR', 'COL_SEPERATOR'];\n\n  if (oldDataSource) {\n    oldDataSource = JSON.parse(oldDataSource);\n    Object.keys(oldDataSource).forEach(function (key) {\n      _newArrowCheck(this, _this5);\n\n      if (!skipList.includes(key)) {\n        _dataSource__WEBPACK_IMPORTED_MODULE_2__[\"dataSource\"][key] = oldDataSource[key];\n      }\n    }.bind(this));\n    select.value = _dataSource__WEBPACK_IMPORTED_MODULE_2__[\"dataSource\"].type;\n    btn.className = 'btn btn-done'; // btn.innerHTML = '<span class=\"fa fa-bar-chart\"></span>';\n\n    btn.setAttribute('onClick', 'javascript:dataSource.canHaveJson();modalClose(\\'modal-spreadsheet\\');');\n    document.getElementById('chart-type').removeAttribute('style');\n    _dataSource__WEBPACK_IMPORTED_MODULE_2__[\"dataSource\"].showPreview();\n    _dataSource__WEBPACK_IMPORTED_MODULE_2__[\"dataSource\"].canHaveJson();\n\n    if (oldChartObject) {\n      Object(_createchart_js__WEBPACK_IMPORTED_MODULE_0__[\"setChartObject\"])(JSON.parse(oldChartObject));\n      _createchart_js__WEBPACK_IMPORTED_MODULE_0__[\"chart\"].setJSONData(Object(_filterLink__WEBPACK_IMPORTED_MODULE_3__[\"filterLink\"])());\n    }\n\n    document.getElementById('txt-file-name').innerHTML = _dataSource__WEBPACK_IMPORTED_MODULE_2__[\"dataSource\"].fileName || 'No File Chosen';\n  }\n};\n\nwindow.init = function () {\n  var workspaceContainer = document.getElementById('workspace-container');\n  workspaceContainer.style.cssText = 'height:' + (window.innerHeight - document.getElementById('header').offsetHeight) + 'px';\n  document.getElementById('aside-menu').style.cssText = 'height:' + (window.innerHeight - document.getElementById('header').offsetHeight) + 'px';\n};\n\nwindow.setChartContainerSize = function (width, height) {\n  if (height === '100%') {\n    document.getElementById('chart-width').value = '';\n    document.getElementById('chart-height').value = '';\n    document.getElementById('chart-container').style.cssText = 'height:' + (window.innerHeight - document.getElementById('header').offsetHeight - 70) + 'px';\n  } else {\n    document.getElementById('chart-container').removeAttribute('style');\n  }\n\n  if (_createchart_js__WEBPACK_IMPORTED_MODULE_0__[\"chart\"]) {\n    _createchart_js__WEBPACK_IMPORTED_MODULE_0__[\"chart\"].resizeTo(width, height);\n  }\n};\n\nwindow.start = function () {\n  document.getElementById('fileUpload').onchange = function (e) {\n    _dataSource__WEBPACK_IMPORTED_MODULE_2__[\"dataSource\"].cleanSelection();\n    _dataSource__WEBPACK_IMPORTED_MODULE_2__[\"dataSource\"].cleanData();\n    document.getElementById('txt-file-name').innerHTML = this.files[0] ? this.files[0].name : _dataSource__WEBPACK_IMPORTED_MODULE_2__[\"dataSource\"].fileName;\n    var reader = new FileReader();\n\n    reader.onload = function (evt) {\n      _dataSource__WEBPACK_IMPORTED_MODULE_2__[\"dataSource\"].init(reader.result);\n    };\n\n    reader.readAsText(this.files[0]);\n    _dataSource__WEBPACK_IMPORTED_MODULE_2__[\"dataSource\"].fileName = this.files[0].name;\n  };\n\n  document.getElementById('chart-width').addEventListener('keyup', function () {\n    setChartContainerSize(document.getElementById('chart-width').value, document.getElementById('chart-height').value);\n  });\n  document.getElementById('chart-height').addEventListener('keyup', function () {\n    setChartContainerSize(document.getElementById('chart-width').value, document.getElementById('chart-height').value);\n  });\n  document.getElementById('btn-export-html').addEventListener('click', function (e) {\n    Object(_aside_exportHTML__WEBPACK_IMPORTED_MODULE_6__[\"exportHTML\"])(e);\n  });\n  _snackbar__WEBPACK_IMPORTED_MODULE_1__[\"snackbar\"].init();\n\n  window.onload = function () {\n    init();\n    initChartSelection();\n\n    if (localStorage) {\n      restoreSession();\n    }\n  };\n\n  window.onresize = function () {\n    init();\n  };\n}();\n\n//# sourceURL=webpack:///./src/js/index.js?");
